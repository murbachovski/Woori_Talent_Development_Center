...
```
교차로 교통 장애물 및 이벤트 감지 시스템 개발 - 팀 프로젝트 계획

✅ 프로젝트 개요

목표: 교차로에서 발생하는 장애물 및 이벤트를 감지하는 AI 기반 시스템 개발
진행 기간: 4월 1일 ~ 4월 18일
...
main, dev, feature/각 팀별 작업

README.md 작성 (프로젝트 개요, 목표, 팀원 역할 포함)

Issue 및 Pull Request 템플릿 작성

주제 선정 (교차로 장애물 감지의 세부 주제 확정)
